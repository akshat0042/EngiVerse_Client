      ...
      <div className=" flex flex-row h-full w-full z-10 ">
            <div className={`w-20  h-screen bg-[#1E1F22] top-0 left-0 flex flex-col-reverse`}>
                <div className=" space-y-2">
                  <button className={`w-12 text-[#E1E4E6] rounded-full center h-12 bg-[#313338]`} onClick={grp}>
                    +<br/>
                  </button>
                  <button className={`w-12 text-[#E1E4E6] rounded-full center h-12 bg-[#313338]`} onClick={exp}>
                    Explor<br/>
                  </button>
                  <button className={`w-12 text-[#E1E4E6] rounded-full center h-12 bg-[#313338]`}>
                    set<br/>
                  </button>
                  <button className={`w-12 text-[#E1E4E6] rounded-full center h-12 bg-[#313338] `} onClick={ecomm}>
                    ecom<br/>
                  </button>
                </div>
                <div className=" h-full flex-col space-y-2 overflow-y-auto no-scrollbar">
                <button className={`w-12 text-[#E1E4E6] rounded-full h-12 bg-[#313338] mt-3 hover:transform scale-105 duration-300 ease-in-out hover:rounded-md`}
                >
                  gc
                </button>
                  ...
                  <div className={`h-[40%] ${isHoveredProfilePic ? 'opacity-75 ' : 'group-hover:opacity-30'} rounded-t-md`} onMouseEnter={() => setIsHoveredProfilePic(true)} onMouseLeave={() => setIsHoveredProfilePic(false)}>
                    ...
                    <div className="h-[60%] flex flex-row bg-[#1E1F22]">
                      ...
                      <div className=" flex flex-col h-full bg-black w-full">
                          <div className="h-[2.9rem] bg-[#1E1F22] text-[#CACACA] sheeshfont text-xl"> people added</div>
